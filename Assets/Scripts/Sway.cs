...
public class Sway : MonoBehaviour
{
    ...
    private void UpdateSway()
    {
        ...
        Quaternion t_xAngleAdjustment = Quaternion.AngleAxis(-t_xLookInput * 50f, Vector3.up);
        Quaternion t_yAngleAdjustment = Quaternion.AngleAxis(t_yLookInput * 50f, Vector3.right);
